...
const Sidebar = () => {
    ...
    return (<>
        ...
        <Drawer className=" w-full bg-gray-900 bg-opacity-40 shadow-lg  border-opacity-18  relative" isOpen={isOpen} placement="left" onClose={onClose} finalFocusRef={btnRef}>
            <DrawerOverlay />
            <DrawerContent className=" w-full bg-gray-900 bg-opacity-40 shadow-lg  border-opacity-18  relative">
                <DrawerCloseButton />
                <DrawerHeader className=" font-montserrat font-normal text-3xl text-center text-white pt-8 tracking-wider">OTC Nexus</DrawerHeader>
