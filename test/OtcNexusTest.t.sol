...
contract OtcNexusTest is OtcNexusTestSetup {
    function test_computeAmount0_dynamic_with_valid_usd_price() public {
        ...
        uint256 amount0 = otcNexusMocked.computeAmount0Visible(
            rfsId,
            1000,
            0,
            OtcNexus.RfsType.DYNAMIC
        );
    ...
    function test_computeAmount0_fixed_with_valid_amounts() public {
        ...
        uint256 amount0Temp = otcNexusMocked.computeAmount0Visible(
            rfsId,
            100,
            0,
            OtcNexus.RfsType.FIXED
        );
